...
# === Configuration ===
# Load secrets from Environment Variables. DO NOT HARDCODE THEM HERE.
ASANA_TOKEN = os.getenv('ASANA_TOKEN')
ASANA_PROJECT_ID = os.getenv('ASANA_PROJECT_ID')

# All your functions (log_message, extract_paragraph_text, etc.) go here
# ... (copy all the functions from your original script without changes) ...
...
def create_asana_task(task_name, task_notes):
    ...
    if not ASANA_TOKEN or not ASANA_PROJECT_ID:
        error_msg = "Server configuration error: ASANA_TOKEN or ASANA_PROJECT_ID not set."
        log_message(error_msg, "ERROR")
        return {"status": "error", "message": error_msg, "error_type": "configuration"}
...
# IMPORTANT: DO NOT INCLUDE the if __name__ == "__main__": block.
# Vercel handles running the app.